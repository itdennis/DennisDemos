...
namespace AvePoint.Migrator.Common.Controls
{
    ...
    public class DataGridHeaderBorder : Border
    {
        ...
        private void RenderClassic(DrawingContext dc)
        {
            ...
            Brush background = new SolidColorBrush(Color.FromRgb(235, 235, 235));
            ...
            {
                darkDarkRight = SeparatorBrush;// SystemColors.ControlDarkDarkBrush;
            }
            ...
            {
                darkDarkBottom = SeparatorBrush;// SystemColors.ControlDarkDarkBrush;
            }
