...
{
    /// <summary>
    /// Provides date for the dateValidationError event.
    /// </summary>
    public class DateTimePickerDateValidationErrorEventArgs:EventArgs
    {
        ...
        /// <param name="text">The text being parsed.</param>
         public DateTimePickerDateValidationErrorEventArgs(Exception exception, string text)
        {
            this.Text = text;
