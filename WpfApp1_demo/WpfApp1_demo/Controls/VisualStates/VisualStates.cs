...
namespace AvePoint.Migrator.Common.Controls
{
    internal static class VisualStates
    {
        ...
        #region GroupHighlight

        /// <summary>
        /// VSM group for UnHighlight states
        /// </summary>
        public const string StateUnHighlight = "UnHighlight";

        /// <summary>
        /// VSM state for Highlight defined
        /// </summary>
        public const string StateHighlight = "Highlight";

        #endregion GroupHighlight

        #region GroupFilter

        /// <summary>
        /// VSM group for UnFilter states
        /// </summary>
        public const string StateUnFilter = "UnFilter";

        /// <summary>
        /// VSM state for Filter defined
        /// </summary>
        public const string StateFilter = "Filter";
