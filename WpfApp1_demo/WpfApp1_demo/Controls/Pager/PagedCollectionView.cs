...
namespace AvePoint.Migrator.Common.Controls
{
    ...
    using MigratorTool.WPF.View.Controls.Pager;
    #endregion
    ...
    public sealed class PagedCollectionView : ICollectionView, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged
    {
        ...
        public Predicate<object> Filter
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException("OperationNotAllowedDuringAddOrEdit");
                }

                if (!this.CanFilter)
                {
                    throw new NotSupportedException("CannotFilter");
                }
        ...
        public NewItemPlaceholderPosition NewItemPlaceholderPosition
        {
            ...
            set
            {
                ...
                {
                    //throw new ArgumentException(string.Format("InvalidEnumArgument"));
                }
            }
        }
            ...
            set
            {
                ...
                if (this._pageSize != value)
                {
                    ...
                    if (this.CurrentAddItem != null || this.CurrentEditItem != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException("ChangingPageSizeNotAllowedDuringAddOrEdit");
                        }
        ...
        public void Refresh(IEnumerable source)
        {
            this._sourceCollection = source;
            this._internalList = this.PrepareLocalArray(this._sourceCollection);
            this.OnItemCountChanged.Execute(this.PageCount);
            this.Refresh();
            this.MoveToFirstPage();
        }
        ...
        public object AddNew()
        {
            ...
            if (!this.CanAddNew)
            {
                throw new InvalidOperationException("OperationNotAllowedForView");
            }
        ...
        public void CancelEdit()
        {
            if (this.IsAddingNew)
            {
                throw new InvalidOperationException("OperationNotAllowedDuringTransaction");
            }
        ...
        public void RemoveAt(int index)
        {
            ...
            {
                throw new InvalidOperationException("RemoveNotSupported");
            }
        ...
        public int CurrentPageLastItemIndex
        {
            get
            {
                ...
                {
                    //return this.TotalItemCount - (this.PageSize * this.PageIndex) - 1;
                    return this.TotalItemCount - 1;
                }
    ...
    internal static class TypeHelper
    {
        ...
        private static PropertyInfo GetNestedProperty(this Type parentType, string propertyPath, out Exception exception, ref object item)
        {
            ...
            for (int i = 0; i < propertyNames.Count; i++)
            {
                ...
                {
                    exception = new InvalidOperationException(                        "PropertyNotReadable");
                    item = null;
                    return null;
                }
